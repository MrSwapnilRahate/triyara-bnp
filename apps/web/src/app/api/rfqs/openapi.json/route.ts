...
import { rfqOpenApiDocument } from '@/lib/rfq-openapi'

// GET /api/rfqs/openapi.json - machine-readable description of this API.
...
export function GET(req: Request) {
  return route(req, async () => {
    await requireAuth()
    return NextResponse.json(rfqOpenApiDocument, {
